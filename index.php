            ...
            <div class="nav-actions">
                ...
                <?php if(isset($_SESSION['usuario_nome'])): ?>
                    ...
                    <?php if(isset($_SESSION['usuario_nivel']) && $_SESSION['usuario_nivel'] === 'admin'): ?>
                        ...
                        <a href="painel.php" class="btn-chip btn-chip-blue">
                            Painel Admin
                        </a>

                    <?php endif; ?>

                    <a href="logout.php" class="btn-chip btn-chip-red">
                        Sair
                    </a>

                <?php else: ?>

                    <a href="login.php" class="btn-chip btn-chip-ghost">
                        Login
                    </a>

                    <a href="cadastro.php" class="btn-chip btn-chip-blue">
                        Cadastrar
                    </a>
    ...
    <section id="home" class="hero">
        ...
        <div class="hero-bg">
            ...
            <!--
                ...
                Coloque o arquivo:
                Gemini_Generated_Image_o0vq11o0vq11o0vq.jpg
            ...
            <img
                src="img/Gemini_Generated_Image_o0vq11o0vq11o0vq.jpg"
            ...
            <form
                ...
                <div class="form-group">
                    ...
                    <select
                        ...
                        <option value="Notebook Dell Inspiron 15">
                            Compra: Notebook Dell Inspiron 15
                        </option>
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        name="mensagem"
                        rows="5"
                        placeholder="Descreva sua necessidade ou especificações adicionais..."></textarea>
